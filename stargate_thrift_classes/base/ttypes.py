...
class Tier(object):
    ...
    def __init__(
        ...
        maintenanceAmountUsdt=None,
    ):
        self.bracketMax = bracketMax
        self.maxLeverage = maxLeverage
        self.maintenanceMarginRate = maintenanceMarginRate
        self.maintenanceAmountUsdt = maintenanceAmountUsdt
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I16:
                    self.maxLeverage = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.maintenanceMarginRate = (
                        iprot.readString().decode("utf-8", errors="replace")
                        if sys.version_info[0] == 2
                        else iprot.readString()
                    )
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin("Tier")
        if self.bracketMax is not None:
            oprot.writeFieldBegin("bracketMax", TType.STRING, 1)
            oprot.writeString(
                self.bracketMax.encode("utf-8")
                if sys.version_info[0] == 2
                else self.bracketMax
            )
            oprot.writeFieldEnd()
        if self.maxLeverage is not None:
            oprot.writeFieldBegin("maxLeverage", TType.I16, 2)
            oprot.writeI16(self.maxLeverage)
            oprot.writeFieldEnd()
        if self.maintenanceMarginRate is not None:
            oprot.writeFieldBegin("maintenanceMarginRate", TType.STRING, 3)
            oprot.writeString(
                self.maintenanceMarginRate.encode("utf-8")
                if sys.version_info[0] == 2
                else self.maintenanceMarginRate
            )
            oprot.writeFieldEnd()
        if self.maintenanceAmountUsdt is not None:
            oprot.writeFieldBegin("maintenanceAmountUsdt", TType.STRING, 4)
            oprot.writeString(
                self.maintenanceAmountUsdt.encode("utf-8")
                if sys.version_info[0] == 2
                else self.maintenanceAmountUsdt
            )
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        if self.bracketMax is None:
            raise TProtocolException(message="Required field bracketMax is unset!")
        if self.maxLeverage is None:
            raise TProtocolException(message="Required field maxLeverage is unset!")
        if self.maintenanceMarginRate is None:
            raise TProtocolException(
                message="Required field maintenanceMarginRate is unset!"
            )
        if self.maintenanceAmountUsdt is None:
            raise TProtocolException(
                message="Required field maintenanceAmountUsdt is unset!"
            )
        return
